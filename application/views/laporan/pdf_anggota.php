...
$pdf->SetTitle('Laporan Data Anggota Perpustakaan');
...
$table1 .= '<tr>
                    <td style="text-align:center; font-family:sans-serif; font-size:16px; font-weigth:bold;">LAPORAN DATA ANGGOTA PERPUSTAKAAN</td>
              </tr>';
$table1 .= '</table> <br>';

$table2 = '<table border="1" width="630px">';
$table2 .= '<tr style="background-color:lightgreen">
                    <td height="30" style="text-align:center; font-weight:bold; font-family:sans-serif; font-size:14px;">Id Anggota</td>
                    <td style="text-align:center; font-weight:bold; font-family:sans-serif; font-size:14px;">NIM</td>
                    ...
                    <td style="text-align:center; font-weight:bold; font-family:sans-serif; font-size:14px;">No HP</td>
              </tr>';
foreach ($data as $row) {
    $table2 .= '<tr>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">' . $row->id_anggota . '</td>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">' . $row->nim . '</td>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">' . $row->nama_anggota . '</td>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">' . $row->gender . '</td>
