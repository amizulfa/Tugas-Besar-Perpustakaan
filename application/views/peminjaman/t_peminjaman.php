...
<div class="col-md-12">
    <div class="box box-info">
        ...
        <form method="post" action="<?= site_url("peminjaman/simpan") ?>" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="date" name="tgl_pinjam" class="form-control" value="<?= $tgl_pinjam; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="date" name="tgl_kembali" class="form-control" value="<?= $tgl_kembali; ?>">
                </div>
            </div>

            <div class="box-footer">
                <a href="<?= site_url("peminjaman") ?>" class="btn btn-warning">Cancel</a>
    ...
    <script>
        $('#id_buku').change(function() {
            var id = $(this).val();
            $.ajax({
                url: '<?= site_url("peminjaman/jumlah_buku") ?>',
                data: {
                    id: id
                },
                method: 'POST',
                ...
                success: function(hasil) {
                    ...
                    if (jumlah1 <= 0) {
                        alert('Maaf, Stok untuk buku ini kosong');
                        location.reload();
                    }
                }
            })
