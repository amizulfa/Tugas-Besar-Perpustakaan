<div class="col-md-12">
    <div class="box box-info">
        ...
        <form method="post" action="<?= site_url("anggota/update") ?>" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">NIM Anggota</label>
                    <div class="col-sm-10">
                        <input type="text" name="nim" value="<?= $data['nim']; ?>" class="form-control" placeholder="NIM" required>
                    </div>
                </div>
            ...
            <div class="box-footer">
                <a href="<?= site_url("anggota") ?>" class="btn btn-warning">Cancel</a>
